                ...
                <CardContent className="space-y-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-2">
                      ...
                      <Input id="firstName" value={user?.fullName?.split(' ')[0] || ''} />
                    </div>
                    <div className="space-y-2">
                      <Label htmlFor="lastName">Last Name</Label>
                      <Input id="lastName" value={user?.fullName?.split(' ')[1] || ''} />
                    </div>
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <Input id="phone" type="tel" placeholder="+44 20 7123 4567" />
                  </div>
                ...
                <CardContent className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-2">
                      ...
                      <Input id="orgEmail" type="email" value={organizationSettings.email} />
                    </div>
                    <div className="space-y-2">
                      <Label htmlFor="orgPhone">Phone</Label>
                      <Input id="orgPhone" type="tel" value={organizationSettings.phone} />
                    </div>
                  </div>

                  <div className="space-y-2">
                    <Label htmlFor="orgAddress">Address</Label>
                    <Textarea id="orgAddress" value={organizationSettings.address} />
                  </div>
              ...
              <Card>
                ...
                <CardContent className="space-y-6">
                  <div className="space-y-4">
                    ...
                    <div className="flex items-center justify-between">
                      <div className="space-y-0.5">
                        <Label htmlFor="incident-notifications">Incident Alerts</Label>
                        <p className="text-sm text-gray-600 dark:text-gray-400">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="flex items-center gap-2">
                        <Select defaultValue={securitySettings.passwordComplexity}>
                        ...
                        <Badge className={getComplexityColor(securitySettings.passwordComplexity)}>
