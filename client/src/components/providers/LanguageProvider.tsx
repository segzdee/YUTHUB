...
const translations: Record<Language, Record<string, string>> = {
  ...
  es: {
    ...
    comprehensive_platform:
      'Plataforma Integral de Gestión de Vivienda Juvenil',
  },
  fr: {
    ...
    comprehensive_platform:
      'Plateforme Complète de Gestion du Logement Jeunesse',
  },
  de: {
    dashboard: 'Dashboard',
...
export function LanguageProvider({ children }: { children: React.ReactNode }) {
  const [language, setLanguage] = useState<Language>(() => {
    ...
    return (
      (stored as Language) || (translations[browserLang] ? browserLang : 'en')
    );
  });
