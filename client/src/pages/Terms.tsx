...
export default function Terms() {
  const structuredData = {
    ...
    description:
      'YUTHUB Terms of Service - Legal terms and conditions for using our youth housing management platform',
        ...
        <div className='max-w-4xl mx-auto px-4 py-12'>
          ...
          <section>
            ...
            <p>
              ...
              Wales. Any disputes arising from the use of our services will be
            ...
            <div className='mt-4 p-4 bg-neutral-50 rounded-lg'>
              ...
              <p>
                <strong>Dispute Resolution:</strong> UK Courts
              </p>
              <p>
          ...
          <section>
            ...
            <p>
              YUTHUB provides a comprehensive youth housing management platform
              designed to support organizations in managing housing services,
              resident support, and compliance tracking.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              We strive to provide 99.9% uptime for our services. Planned
              maintenance will be communicated in advance through our system
              status page and email notifications.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              ...
              be notified of significant changes via email and through the
            ...
            <div className='mt-4 p-4 bg-info/10 border border-info/20 rounded-lg'>
              <p>
                <strong>Notification Method:</strong> Email and in-app
                notifications
              </p>
              <p>
                <strong>Notice Period:</strong> 30 days for material changes
              </p>
            </div>
          </section>
          ...
          <section>
            ...
            <div className='mt-4 p-4 bg-neutral-50 rounded-lg'>
              <p>
                <strong>Email:</strong> legal@yuthub.com
              </p>
              <p>
                <strong>Phone:</strong> +44 20 7123 4567
              </p>
              <p>
                <strong>Address:</strong> YUTHUB Ltd, London, United Kingdom
              </p>
            </div>
          </section>
          </div>
