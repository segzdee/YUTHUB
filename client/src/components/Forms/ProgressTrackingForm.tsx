...
import { Calendar, User, Target, TrendingUp, CheckCircle2, Clock } from "lucide-react";
...
const progressUpdateSchema = z.object({
  ...
  goalType: z.enum(["independence", "education", "employment", "health", "social", "life_skills"]),
...
export default function ProgressTrackingForm() {
  ...
  const handleSubmit = async (data: any) => {
    try {
      ...
      const response = await apiRequest("POST", "/api/progress-tracking", progressData);
    ...
    <div className="min-h-screen bg-gray-50 py-8 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto">
        <div className="mb-8">
          ...
          <p className="text-gray-600">Update and monitor resident progress towards their support plan goals</p>
        </div>
                            ...
                            <SelectItem key={resident.id} value={resident.id.toString()}>
                              <div className="flex items-center justify-between w-full">
                                ...
                                <div className="flex space-x-2 ml-4">
                                  <Badge variant="secondary">{resident.currentGoals} active</Badge>
                                  <Badge variant="outline">{resident.completedGoals} completed</Badge>
                                </div>
                              </div>
                            </SelectItem>
                          ))}
            ...
            {selectedGoal && (
              <Card>
                ...
                <CardContent className="space-y-6">
                  ...
                  <div>
                    <Label className="text-base font-medium mb-4 block">Milestones</Label>
                    <div className="space-y-2">
                      {selectedGoal.milestones.map((milestone: string, index: number) => (
