...
import { AlertTriangle, Phone, Clock, Shield, MessageSquare, User, Plus, CheckCircle } from "lucide-react";
...
export default function Crisis() {
  ...
  const getContactTypeColor = (type: string) => {
    switch (type) {
      ...
      case "safeguarding": return "bg-purple-100 text-purple-800";
      ...
      <div className="flex-1 lg:ml-64 flex flex-col">
        ...
        <main className="flex-1 overflow-y-auto p-4 sm:p-6">
          <div className="mb-6 sm:mb-8">
            <h1 className="text-2xl font-bold text-gray-900 dark:text-white mb-2">Crisis Connect</h1>
            <p className="text-gray-600 dark:text-gray-400">
              24/7 emergency response, crisis support, and rapid intervention tools
            </p>
          </div>
          ...
          {activeCall && (
            <Alert className="mb-6 border-red-200 bg-red-50">
              ...
              <AlertDescription className="text-red-800">
                <strong>Emergency Call Active</strong> - Connected to emergency services
              </AlertDescription>
            </Alert>
          )}
          ...
          <Tabs defaultValue="emergency" className="space-y-6">
                      ...
                      <div className="space-y-3">
                        ...
                        <div className="flex items-center justify-between">
                          <div className="flex items-center gap-1">
                            ...
                            <span className="text-sm text-green-600">{contact.available}</span>
                          </div>
                          <Button
                            size="sm"
            ...
            <TabsContent value="protocols" className="space-y-6">
              <div className="flex flex-col sm:flex-row gap-4 items-start sm:items-center justify-between">
                <h2 className="text-lg font-semibold text-gray-900 dark:text-white">Crisis Response Protocols</h2>
            ...
            <TabsContent value="support" className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <Card>
                  <CardHeader>
                    <CardTitle className="text-lg">24/7 Support Services</CardTitle>
                    <CardDescription>Always available support resources</CardDescription>
                  </CardHeader>
                  <CardContent>
                    <div className="space-y-4">
                      <div className="flex items-center gap-3 p-3 bg-blue-50 rounded-lg">
                        ...
                        <div>
                          ...
                          <div className="text-sm text-gray-600">Live chat support available</div>
                        </div>
                      ...
                      <div className="flex items-center gap-3 p-3 bg-green-50 rounded-lg">
                        ...
                        <div>
                          ...
                          <div className="text-sm text-gray-600">0800 123 4567</div>
                        </div>
                        <Button size="sm" className="ml-auto">
                          Call
                        </Button>
                      ...
                      <div className="flex items-center gap-3 p-3 bg-purple-50 rounded-lg">
                        ...
                        <div>
                          ...
                          <div className="text-sm text-gray-600">Emergency support worker</div>
                        </div>
                        <Button size="sm" className="ml-auto">
                          Contact
                        </Button>
                ...
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>Immediate coping strategies and tools</CardDescription>
                  </CardHeader>
                  <CardContent>
                    <div className="space-y-4">
                      <div className="p-3 bg-gray-50 rounded-lg">
                        <h4 className="font-medium mb-2">Breathing Exercises</h4>
                        <p className="text-sm text-gray-600">4-7-8 breathing technique for anxiety</p>
                      </div>
                      <div className="p-3 bg-gray-50 rounded-lg">
                        <h4 className="font-medium mb-2">Grounding Techniques</h4>
                        <p className="text-sm text-gray-600">5-4-3-2-1 sensory grounding method</p>
                      </div>
                      <div className="p-3 bg-gray-50 rounded-lg">
                        <h4 className="font-medium mb-2">Crisis Safety Plan</h4>
                        <p className="text-sm text-gray-600">Personal safety planning template</p>
                      </div>
                    </div>
                  </CardContent>
                </Card>
            ...
            <TabsContent value="history" className="space-y-6">
              <div className="flex flex-col sm:flex-row gap-4 items-start sm:items-center justify-between">
                <h2 className="text-lg font-semibold text-gray-900 dark:text-white">Crisis Response History</h2>
                <Button className="flex items-center gap-2">
                  <Plus className="h-4 w-4" />
                  Log Incident
                </Button>
                  ...
                  <Card>
                    <CardContent className="flex items-center justify-center py-8">
                      <div className="text-center">
                        ...
                        <p className="text-gray-500">No crisis incidents recorded</p>
                      </div>
                    </CardContent>
                  </Card>
                ) : (
                  recentCrises.map((crisis) => (
                    <Card key={crisis.id} className="hover:shadow-md transition-shadow">
                      <CardHeader>
                        <div className="flex items-start justify-between">
                          <div className="flex items-center gap-3">
                            <div className="p-2 bg-primary/10 rounded-lg">
                            ...
                            <div>
                              <CardTitle className="text-lg">{crisis.type} Crisis</CardTitle>
                              <CardDescription>
                      ...
                      <CardContent>
                        <div className="space-y-3">
                          <div className="grid grid-cols-2 gap-4">
                            <div>
                              <span className="text-sm text-gray-600 dark:text-gray-400">Responder</span>
                              <div className="text-sm font-medium">{crisis.responder}</div>
                            </div>
                            <div>
                              <span className="text-sm text-gray-600 dark:text-gray-400">Status</span>
                              <div className="text-sm font-medium">{crisis.status}</div>
                            </div>
                          </div>
                          <div>
