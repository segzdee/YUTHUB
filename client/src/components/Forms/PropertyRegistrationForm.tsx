...
const propertyConfigSchema = z.object({
  ...
  smokingPolicy: z
    .enum(['no_smoking', 'designated_areas', 'allowed'])
    .default('no_smoking'),
            ...
            render={({ field }) => (
              <FormItem>
                ...
                >
                  ...
                  <SelectContent>
                    <SelectItem value='shared_housing'>
                      Shared Housing
                    </SelectItem>
                    <SelectItem value='studio_units'>Studio Units</SelectItem>
                    <SelectItem value='transition_units'>
                      Transition Units
                    </SelectItem>
                  </SelectContent>
                </Select>
      ...
      <div className='space-y-6'>
            ...
            <div className='grid grid-cols-2 md:grid-cols-3 gap-2'>
              {facilityOptions.map(facility => (
                <Button
                  ...
                  type='button'
                  variant={
                    facilities.includes(facility) ? 'default' : 'outline'
                  }
                  size='sm'
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Select accessibility features available
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className='grid grid-cols-2 md:grid-cols-3 gap-2'>
            ...
            <div className='space-y-3'>
              <div className='flex items-center space-x-2'>
                <input
                  ...
                  onChange={e =>
                    handleValueChange('allowPets', e.target.checked)
                  }
                />
          ...
          <CardContent>
            <div className='flex items-center space-x-2'>
              <input
                ...
                onChange={e =>
                  handleValueChange('internetProvided', e.target.checked)
                }
              />
          ...
          <CardContent>
            <div className='flex items-center space-x-2'>
              <input
                ...
                onChange={e =>
                  handleValueChange('laundryFacilities', e.target.checked)
                }
              />
