...
export default function Cookies() {
  ...
  const structuredData = {
    ...
    name: 'Cookie Policy',
    description:
      'YUTHUB Cookie Policy - Manage your cookie preferences for our youth housing management platform',
        ...
        <div className='max-w-4xl mx-auto px-4 py-12'>
          ...
          <section className='text-medium-contrast'>
            ...
            <p>
              ...
              manage your cookie preferences below and opt-out of non-essential
              cookies at any time.
            </p>
          </section>
          ...
          <section className='text-medium-contrast'>
            ...
            <div className='space-y-6'>
              ...
              <div>
                ...
                <p>
                  Remain on your device for a specified period. Used to remember
              ...
              <div>
                ...
                <p>
                  Set by external services we use for analytics and
                  functionality. You can opt-out of these cookies.
                </p>
              </div>
            </div>
          </section>
          ...
          <section className='text-medium-contrast'>
            ...
            <p>
              You can control cookies through your browser settings or by using
              the preferences above. Note that disabling certain cookies may
            ...
            <div className='mt-4 p-4 bg-warning/10 border border-warning/20 rounded-lg'>
              ...
              <p>
                <strong>Third-Party Opt-Out:</strong> Visit{' '}
                <a
