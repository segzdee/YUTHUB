...
export default function Privacy() {
  const structuredData = {
    ...
    name: 'Privacy Policy',
    description:
      'YUTHUB Privacy Policy - How we protect and handle your personal data',
        ...
        <div className='space-y-8 text-medium-contrast'>
          <section>
            ...
            <p>
              ...
              our data protection strategy and ensuring compliance with GDPR
              requirements.
            </p>
            <div className='mt-4 p-4 bg-neutral-50 rounded-lg'>
              <p>
                <strong>Contact:</strong> dpo@yuthub.com
              </p>
              <p>
          ...
          <section>
            ...
            <p>
              We collect and process personal data in accordance with GDPR and
              UK data protection laws. This includes:
            </p>
          ...
          <section>
            ...
            <p>
              ...
              Housing records are retained according to local government
              guidelines.
            </p>
          </section>
          ...
          <section>
            ...
            <div className='mt-4 p-4 bg-neutral-50 rounded-lg'>
              <p>
                <strong>Email:</strong> privacy@yuthub.com
              </p>
              <p>
