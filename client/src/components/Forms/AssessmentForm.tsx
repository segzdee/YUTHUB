...
export default function AssessmentForm({
  ...
  const createAssessmentMutation = useMutation({
    mutationFn: (data: any) =>
      apiRequest('POST', '/api/assessment-forms', data),
    onSuccess: () => {
      toast({
        title: 'Success',
  ...
  const getAssessmentQuestions = (type: string) => {
    const questions = {
      intake: [
        {
          id: 'housing_history',
          question: 'Previous housing experience',
          type: 'text',
        },
        {
          id: 'support_needs',
          question: 'Primary support needs',
          type: 'multiselect',
        },
        {
          id: 'independence_level',
          question: 'Current independence level (1-5)',
          type: 'number',
        },
        {
          id: 'risk_factors',
          question: 'Identified risk factors',
          type: 'multiselect',
        },
      ...
      review: [
        {
          id: 'progress_made',
          question: 'Progress since last review',
          type: 'text',
        },
        { id: 'challenges', question: 'Current challenges', type: 'text' },
        {
          id: 'support_effectiveness',
          question: 'Support plan effectiveness (1-5)',
          type: 'number',
        },
      ...
      move_on: [
        {
          id: 'readiness_level',
          question: 'Readiness for independent living (1-5)',
          type: 'number',
        },
        {
          id: 'skills_assessment',
          question: 'Life skills assessment',
          type: 'text',
        },
        {
          id: 'support_networks',
          question: 'Support networks in place',
          type: 'text',
        },
        {
        ...
        {
          id: 'ongoing_support',
          question: 'Ongoing support requirements',
          type: 'text',
        },
      ],
      risk: [
        {
          id: 'risk_level',
          question: 'Overall risk level (1-5)',
          type: 'number',
        },
        {
          id: 'risk_factors',
        ...
        },
        {
          ...
          question: 'Risk mitigation strategies',
          type: 'text',
        },
        {
          id: 'monitoring_plan',
          question: 'Monitoring and review plan',
          type: 'text',
        },
      ],
    };
          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className='space-y-6'>
            ...
            {assessmentType && (
              <div className='space-y-4'>
                ...
                {getAssessmentQuestions(assessmentType).map(
                  (question, index) => (
