...
import { Building, Edit, Mail, Phone, Plus, Trash2 } from 'lucide-react';
...
export function GovernmentClientsTab() {
  ...
  const [editingClient, setEditingClient] = useState<GovernmentClient | null>(
    null
  );
  ...
  const createMutation = useMutation({
    mutationFn: (data: ClientFormData) =>
      apiRequest('/api/billing/government-clients', {
        method: 'POST',
        headers: {
    ...
    onSuccess: () => {
      ...
      toast({
        title: 'Success',
        description: 'Government client created successfully',
      });
  ...
  const updateMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      toast({
        title: 'Success',
        description: 'Government client updated successfully',
      });
      setIsDialogOpen(false);
  ...
  const deleteMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      toast({
        title: 'Success',
        description: 'Government client deleted successfully',
      });
    },
    onError: (error: any) => {
      toast({
        ...
        <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
          ...
          <DialogContent className='max-w-4xl max-h-[90vh] overflow-y-auto'>
            <DialogHeader>
              <DialogTitle>
                {editingClient
                  ? 'Edit Government Client'
                  : 'Add Government Client'}
              </DialogTitle>
            </DialogHeader>
                ...
                <div>
                  ...
                  >
                    ...
                    <SelectContent>
                      ...
                      <SelectItem value='housing_association'>
                        Housing Association
                      </SelectItem>
                    </SelectContent>
                  </Select>
