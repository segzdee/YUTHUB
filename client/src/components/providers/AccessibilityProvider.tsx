...
export function AccessibilityProvider({ children }: { children: React.ReactNode }) {
  ...
  useEffect(() => {
    ...
    root.style.setProperty('--animation-duration', preferences.reducedMotion ? '0s' : '0.2s');
    root.style.setProperty('--transition-duration', preferences.reducedMotion ? '0s' : '0.15s');
