...
export default function ProgressReport({ dateRange, properties }: ProgressReportProps) {
  ...
  const goalCategories = [
    { category: 'Independence Skills', total: 18, completed: 12, inProgress: 6, percentage: 67 },
    { category: 'Education & Training', total: 15, completed: 8, inProgress: 7, percentage: 53 },
    { category: 'Employment', total: 12, completed: 7, inProgress: 5, percentage: 58 },
    { category: 'Health & Wellbeing', total: 20, completed: 15, inProgress: 5, percentage: 75 },
    { category: 'Social Skills', total: 10, completed: 6, inProgress: 4, percentage: 60 },
  ];
    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{summaryData.totalResidents}</div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{summaryData.completedGoals}</div>
            <p className="text-xs text-muted-foreground">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{summaryData.averageProgress}%</div>
                ...
                <div className="flex justify-between items-start mb-3">
                  ...
                  <div className="text-right">
                    ...
                    <Badge variant={category.percentage >= 70 ? "default" : category.percentage >= 50 ? "secondary" : "destructive"}>
                      {category.percentage >= 70 ? 'Excellent' : category.percentage >= 50 ? 'Good' : 'Needs Focus'}
                    </Badge>
                  </div>
                </div>
              ...
              <div key={resident.id} className="border rounded-lg p-4">
                <div className="flex justify-between items-start mb-3">
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">
                      Last Assessment: {resident.lastAssessment.toLocaleDateString()}
                    </p>
                  </div>
                  <div className="text-right">
                    <div className="text-lg font-bold">{resident.overallProgress}%</div>
                    <Badge variant={resident.overallProgress >= 80 ? "default" : resident.overallProgress >= 60 ? "secondary" : "destructive"}>
                      {resident.overallProgress >= 80 ? 'Excellent' : resident.overallProgress >= 60 ? 'Good' : 'Needs Support'}
                    </Badge>
                  </div>
                </div>
        ...
        <CardContent>
          <div className="space-y-3">
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="font-medium">{summaryData.successfulMoveOns} Successful Move-Ons</p>
                <p className="text-sm text-muted-foreground">
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="font-medium">75% Health & Wellbeing Goal Success</p>
                <p className="text-sm text-muted-foreground">
          ...
          <div className="space-y-3">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  53% completion rate is below average. Consider additional support or revised goals
                </p>
              </div>
            </div>
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Employment goals show potential for improvement with targeted interventions
                </p>
              </div>
            </div>
            <div className="flex items-start gap-3">
              <div className="w-2 h-2 bg-green-500 rounded-full mt-2"></div>
              <div>
                <p className="font-medium">Replicate Health & Wellbeing Success</p>
                <p className="text-sm text-muted-foreground">
                  Apply successful strategies from health goals to other categories
                </p>
              </div>
            </div>
          </div>
