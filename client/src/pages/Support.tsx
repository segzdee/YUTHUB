...
export default function Support() {  const [searchTerm, setSearchTerm] = useState('');
  ...
  const completedPlans = supportPlans.filter(
      ...
      <main className='space-y-6'>
          <div className='mb-6 sm:mb-8'>
            ...
            <p className='text-gray-600 dark:text-gray-400'>
              Manage support plans, coordinate services, and track resident
              progress
            </p>
          </div>
                        ...
                        <div className='flex items-center gap-3'>
                          ...
                          <div>
                            <CardTitle className='text-lg'>
                              {getResidentName(plan.residentId)}
                            </CardTitle>
            ...
            <TabsContent value='residents' className='space-y-6'>
              ...
              <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6'>
                {residents.map(resident => {
                  const residentPlans = supportPlans.filter(
                    plan => plan.residentId === resident.id
                  );
                  const activePlan = residentPlans.find(
                      ...
                      <CardContent>
                        <div className='space-y-3'>
                          <div className='flex items-center justify-between'>
                            ...
                            <span className='text-sm font-medium'>
                              {
                                residentPlans.filter(p => p.status === 'active')
                                  .length
                              }
                            </span>
                          </div>
                          ...
                          <div className='flex items-center justify-between'>
                            ...
                            <span className='text-sm font-medium'>
                              {activePlan
                                ? getKeyWorkerName(activePlan.keyWorkerId)
                                : 'N/A'}
                            </span>
                          </div>
                        </div>
              ...
              <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6'>
                {staffMembers.length === 0 ? (
                  ...
                  staffMembers.map(staff => {
                    const assignedPlans = supportPlans.filter(
                      plan => plan.keyWorkerId === staff.id
                    );
