...
export default function CrossModuleWidget({
  title,
  type,
  className = '',
  ...
  const calculateMetrics = () => {
    ...
    const occupancyRate =
      totalCapacity > 0 ? (residents.length / totalCapacity) * 100 : 0;
    ...
    const independenceProgressAverage =
      residents.reduce(
        (sum: number, r: any) => sum + (r.independenceLevel || 0),
        0
  ...
  const renderContent = () => {
    switch (type) {
          ...
          <div className='space-y-4'>
            ...
            <div className='space-y-3'>
              ...
              <div className='flex justify-between items-center'>
                ...
                <span className='text-sm font-semibold'>
                  {metrics.incidentRate.toFixed(2)}
                </span>
              </div>
            </div>
            <Button
        ...
        return (
          <div className='space-y-4'>
            ...
            <Button
              ...
              size='sm'
              className='w-full'
              onClick={() => handleNavigation('/housing')}
            >
              View Housing
            </Button>
          </div>
      ...
      case 'incident-alerts':
        ...
        const recentIncidents24h = incidents.filter(
          i =>
          ...
          <div className='space-y-4'>
            ...
            <div className='space-y-3'>
              ...
              <div className='space-y-2'>
                ...
                <Progress
                  value={metrics.independenceProgressAverage * 20}
                  className='h-2'
                />
              </div>
            </div>
            <div className='grid grid-cols-2 gap-2'>
              ...
              <Button
                ...
                size='sm'
                className='w-full'
                onClick={() => handleNavigation('/independence')}
              >
                Independence
              </Button>
            </div>
