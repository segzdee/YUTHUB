...
export class PlatformAdminSecurityTests {
  ...
  static async testNonPlatformAdminAccess() {
    ...
    jest.spyOn(db.query.users, 'findFirst').mockResolvedValue(regularUser as any);
  ...
  static async testPlatformAdminAccess() {
    ...
    jest.spyOn(db.query.users, 'findFirst').mockResolvedValue(platformAdmin as any);
...
export class SubscriptionManagementTests {
  static async testSubscriptionDataIntegrity() {
    ...
    jest.spyOn(db.query.organizationSubscriptions, 'findMany').mockResolvedValue(mockSubscriptions as any);
  ...
  static async testSubscriptionFiltering() {
    ...
    jest.spyOn(db.query.organizationSubscriptions, 'findMany').mockResolvedValue([]);
...
export class OrganizationManagementTests {
  static async testOrganizationListing() {
    ...
    jest.spyOn(db.query.organizations, 'findMany').mockResolvedValue(mockOrganizations as any);
...
export class EmergencyToolsTests {
  static async testOrganizationDisabling() {
    ...
    const req = mockRequest(
      ...
      { action: 'disable_organization', targetId: '1', reason: 'Security concern' }
    );
    const res = mockResponse();
