      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="space-y-8 text-medium-contrast">
          <section>
            ...
            <p>
              YUTHUB is committed to ensuring digital accessibility for people with disabilities. 
          ...
          <section>
            <h2 className="text-2xl font-semibold text-high-contrast mb-4">Conformance Status</h2>
            <p>
            ...
            <p className="mt-4">
              YUTHUB is partially conformant with WCAG 2.1 level AA. Partially conformant means that 
          ...
          <section>
            ...
            <p>
              If you encounter accessibility barriers while using our platform, please contact us:
            </p>
