...
import { AlertTriangle, TrendingUp, TrendingDown, Download, Shield } from "lucide-react";
...
export default function IncidentReport({ dateRange, properties }: IncidentReportProps) {
    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{summaryData.totalIncidents}</div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{summaryData.openIncidents}</div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{summaryData.resolvedIncidents}</div>
            <p className="text-xs text-muted-foreground">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{summaryData.averageResolutionTime} days</div>
            <div className="flex items-center text-xs text-green-600">
              ...
              <div key={type.type} className="border rounded-lg p-4">
                <div className="flex justify-between items-start mb-3">
                  ...
                  <div className="text-right">
                    ...
                    <Badge variant={type.severity === 'high' ? "destructive" : type.severity === 'medium' ? "default" : "secondary"}>
          ...
          <div className="space-y-3">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Focus on resolving the {incidentsBySeverity.find(s => s.severity === 'Critical')?.count} critical incidents immediately
                </p>
              </div>
            </div>
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Safety incidents account for 28% of all incidents. Review and update safety procedures
                </p>
              </div>
            </div>
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Incidents are down 8.5% from last month. Continue current prevention strategies
                </p>
              </div>
            </div>
          </div>
