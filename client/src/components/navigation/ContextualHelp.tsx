      ...
      content: (
        <div className="space-y-3">
          ...
          <ul className="list-disc list-inside space-y-1 text-sm">
            <li><strong>Total Properties:</strong> All properties in your system</li>
            <li><strong>Current Residents:</strong> Active residents across all properties</li>
            <li><strong>Occupancy Rate:</strong> Percentage of occupied rooms</li>
            <li><strong>Active Incidents:</strong> Unresolved incidents requiring attention</li>
          </ul>
        </div>
      ),
  ...
  incidents: [
    {
      ...
      content: (
        <div className="space-y-3">
          <p className="text-amber-600">Important: Report all incidents immediately</p>
          <ul className="list-disc list-inside space-y-1 text-sm">
  ...
  return (
    <div className="border rounded-lg p-3 space-y-2">
      <div className="flex items-start justify-between">
        ...
        >
          {isExpanded ? <X className="h-3 w-3" /> : <Info className="h-3 w-3" />}
        </Button>
      </div>
