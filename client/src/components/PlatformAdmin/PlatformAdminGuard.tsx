...
export default function PlatformAdminGuard({ children }: PlatformAdminGuardProps) {
  ...
  const { data: adminAuth, isLoading, error } = useQuery({
    ...
    return (
      <div className="min-h-screen bg-background flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-medium-contrast">Verifying platform admin access...</p>
        </div>
      </div>
    );
  }
      ...
      <div className="min-h-screen bg-background">
        <div className="max-w-4xl mx-auto p-4">
          <Alert className="border-warning bg-warning/10 mb-6">
            <AlertTriangle className="h-4 w-4" />
            <AlertDescription>
              <strong>Security Warning:</strong> Platform admin access requires additional security measures.
              {!adminAuth.mfaRequired && " Multi-factor authentication is not enabled."}
              {!adminAuth.ipWhitelisted && " Your IP address is not whitelisted for admin access."}
            </AlertDescription>
          </Alert>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <p className="text-medium-contrast">
                Platform admin access requires enhanced security measures to be enabled:
              </p>
              ...
              <div className="space-y-3">
                <div className="flex items-center justify-between p-3 border rounded-lg">
                  <div>
                    ...
                    <p className="text-sm text-medium-contrast">Enable TOTP-based MFA</p>
                  </div>
                ...
                <div className="flex items-center justify-between p-3 border rounded-lg">
                  <div>
                    ...
                    <p className="text-sm text-medium-contrast">Contact system admin</p>
                  </div>
